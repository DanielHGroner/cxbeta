...
const allhelp = { 
    ...
    "12": "Display the calculated BMI.  The <span class='cx-fun'>print()</span> function here displays "+
          "both a string, as well as the value stored in the variable "+
          "<span class='cx-var'>bmi</span>.",
    "14": "Get the user's input and assign it to the variable <span class='cx-var'>anotherWeight</span>. "+
