...
const allhelp = {
    ...
    "7":"Determine <span class='cx-key'>if</span> the initial investment is greater than or equal to 1000; "+
    ...
    "8":"Set the interest rate to 3.25 (if the initial investment was at least 1000).",
    "9":"The <span class='cx-key'>else</span> block covers the case where the initial investment is less than 1000.",
    "10":"Set the interest rate to 3.0 (if the initial investment is less than 1000).",
    "13":"Calculate the ending balance based on the initial investment and interest rate.",
    "16":"Display the interest rate, as previously determined by the <span class='cx-key'>if</span>/<span class='cx-key'>else</span> section.",
    "17":"Display the ending balance.",
