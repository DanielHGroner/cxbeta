// p4da-5-2-help.js
const allhelp = {
    "title":"This program calculates total order cost based on a number of books. "+
            "The function <span class='cx-fun'>calcCost()</span> is defined, which takes one parameter (<span class='cx-var'>numberItems</span>), "+
     ...
     "4":"The <span class='cx-fun'>calcTotal</span> function's signature defines the name of the function, "+
         "as well as defining that the function has one input parameter named <span class='cx-var'>numberItems</span>.",
     "5":"The variable <span class='cx-var'>totalCost</span> is calculated based on the input parameter <span class='cx-var'>numberItems</span>.",
     ...
     "12":"Call the <span class='cx-fun'>calcTotal()</span> function, providing it an argument (the <span class='cx-var'>count</span> variable). "+
